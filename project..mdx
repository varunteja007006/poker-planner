...
1. Whoever voted have to be highlighted. Initial load as well.
2. Who are currently active.
3. Room code should be backend only thing allow users to give room name
